...
CREATE TABLE concursos (
    ...
    -- MEJORA: estado del ciclo de vida del concurso
...
CREATE TABLE fotos (
    ...
    -- MEJORA: equipo al que pertenece la foto (nullable para participación individual)
    equipo_id INT NULL,
    -- MEJORA: estado de moderación de la foto
...
CREATE TABLE concurso_equipos (
    concurso_id INT NOT NULL,
    equipo_id INT NOT NULL,
    -- MEJORA: fecha en que el equipo se inscribió al concurso
...
INSERT INTO concursos (nombre, descripcion, fecha_inicio, fecha_fin, estado) VALUES
('Enfoque Urbano 2026', 'Captura la esencia de las ciudades.', '2026-06-01', '2026-06-30', 'ABIERTO'),
('Naturaleza Viva', 'Paisajes naturales y fauna salvaje.', '2026-07-15', '2026-08-15', 'BORRADOR');
...
INSERT INTO fotos (titulo, url_archivo, participante_id, concurso_id, equipo_id, estado) VALUES
('Luces de la Gran Vía', 'https://storage.concurso.com/fotos/foto1.jpg', 2, 1, 1, 'ACEPTADA'),
('Reflejos bajo la lluvia', 'https://storage.concurso.com/fotos/foto2.jpg', 3, 1, 1, 'ACEPTADA'),
('Amanecer en la montaña', 'https://storage.concurso.com/fotos/foto3.jpg', 4, 2, 2, 'PENDIENTE');
...
INSERT INTO concurso_equipos (concurso_id, equipo_id, fecha_inscripcion) VALUES
(1, 1, '2026-05-28'),
(1, 2, '2026-05-29'),
(2, 2, '2026-06-01'),
(2, 3, '2026-06-02');
